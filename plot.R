...
p_sigma <- ggplot(d_sigma, aes(x = x)) +
  geom_density(aes(fill = "cPY"), col = col[1], alpha = 0.5,bw = 0.025) +
  geom_density(aes(x = y, fill = "PY"),col=col[2], alpha = 0.5, bw = 0.025) +
  scale_fill_manual(values = c("cPY" = col[1], "PY" = col[2]), name = "Model") +
...
p_theta <- ggplot(d_theta, aes(x = x)) +
  geom_density(aes(fill = "cPY"), col = col[1], alpha = 0.5,bw=2.5) +
  geom_density(aes(x = y, fill = "PY"),col=col[2], alpha = 0.5,bw=2.5) +
  scale_fill_manual(values = c("cPY" = col[1], "PY" = col[2]), name = "Model") +
...
p_m1 <- ggplot(d_m1, aes(x = x)) +
  geom_density(aes(fill = "cPY"), col=col[1],alpha = 0.5,bw=1) +
  geom_density(aes(x = y, fill = "PY"), col=col[2],alpha = 0.5,bw=1) +
  scale_fill_manual(values = c("cPY" = col[1], "PY" = col[2]), name = "Model") +
  geom_vline(xintercept = m1_true, linetype="dashed", 
             color = col[3], size=1) +
